...
#include <QFile>
#include <QMouseEvent>
#include <QPainterPath>  // Add this include to fix the error
...
void MyTitleBar::initControl()
{
    ...
    m_pButtonMin->setIcon(QIcon(":/icon_dark/min.png"));
    m_pButtonMin->setIconSize(QSize(40,40));
    m_pButtonRestore->setIcon(QIcon(":/icon_dark/max.png"));
    m_pButtonRestore->setIconSize(QSize(40,40));
    m_pButtonMax->setIcon(QIcon(":/icon_dark/max.png"));
    m_pButtonMax->setIconSize(QSize(40,40));
    m_pButtonClose->setIcon(QIcon(":/icon_dark/.png"));
    m_pButtonClose->setIconSize(QSize(40,40));
